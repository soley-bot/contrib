...
export default function CourseDetail() {
  ...
  async function handleDownloadPdf(group: Group) {
    ...
    generateReport(group, (membersRes.data as GroupMember[]) ?? [], (tasksRes.data as Task[]) ?? [], (activityRes.data as ActivityLog[]) ?? [], evidenceByTask, (evalRes.data as EvaluationSummary[]) ?? [], undefined, 'teacher', course?.name);
