...
export default function NavShell({ profile, homeRoute, sectionLabel, defaultBackLabel, group, title, backLabel, onBack, onTabChange, activeTab, onProfileUpdate, tabBadges }: NavShellProps) {
        ...
        {(group || onBack) ? (
          ...
          >
            ...
            <span className="text-[13px] font-medium truncate max-w-[120px]">
              {backLabel ? backLabel : (group ? defaultBackLabel : 'Back')}
            </span>
          </button>
        ) : (
          <span
