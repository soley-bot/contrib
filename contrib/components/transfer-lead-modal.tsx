    ...
    return (
      ...
      >
        <div className="w-full max-w-[400px] bg-white rounded-xl p-5">
          <p className="text-sm text-text-secondary">No other members to transfer lead to.</p>
          <button onClick={onClose} className="mt-4 w-full h-10 border border-border rounded-md text-sm font-medium text-text-secondary hover:bg-bg-hover transition-colors">
            Dismiss
          </button>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div role="dialog" aria-modal="true" aria-label="Transfer group lead" className="w-full max-w-[400px] bg-white rounded-xl">
        ...
        <div className="p-5">
          <label htmlFor="transfer-lead-select" className="text-[13px] font-medium text-text-secondary mb-1.5 block">Select new lead</label>
          <select
          ...
          <p className="text-xs text-text-tertiary mt-2">You will become a regular member after this change.</p>
        </div>
