...
const ACTION_META: Record<string, { emoji: string; color: string; label: (meta: Record<string, unknown> | null) => string }> = {
  task_created:         { emoji: '📝', color: 'var(--brand)', label: (m) => `created task "${m?.task_title ?? ''}"` },
  task_assigned:        { emoji: '👤', color: 'var(--brand)', label: (m) => `was assigned "${m?.task_title ?? ''}"` },
  ...
  task_reassigned:      { emoji: '👤', color: 'var(--brand)', label: (m) => `reassigned "${m?.task_title ?? ''}" to ${m?.to_name ?? ''}` },
  file_uploaded:        { emoji: '📎', color: 'var(--brand)', label: (m) => `uploaded evidence for "${m?.task_title ?? ''}"` },
  evidence_added:       { emoji: '📎', color: 'var(--brand)', label: (m) => `added evidence for "${m?.task_title ?? ''}"` },
  evidence_version_added: { emoji: '📎', color: 'var(--brand)', label: (m) => `added new version of evidence for "${m?.task_title ?? ''}"` },
  member_joined:        { emoji: '👋', color: 'var(--brand)', label: () => 'joined the group' },
  ...
  lead_transferred:     { emoji: '👑', color: 'var(--brand)', label: (m) => `transferred lead to ${m?.to_name ?? ''}` },
};
