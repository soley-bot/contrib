  ...
  return (
    <div className="flex items-center gap-3 py-3 border-b border-border last:border-none">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-text-tertiary mt-0.5 truncate">{university}</p>
        <div className="flex gap-1.5 flex-wrap mt-1.5">
          <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-bg-hover text-text-secondary">
            {memberTasks.length} tasks
          </span>
          <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-[#DCFCE7] text-green">
