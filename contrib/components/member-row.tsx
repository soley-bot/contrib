...
export default function MemberRow({ member, tasks, isLead }: MemberRowProps) {
  ...
  return (
    <div className="flex items-center gap-3 py-3 border-b border-[#E7E5E4] last:border-none">
      <div className="w-9 h-9 rounded-full bg-[#EEF2FF] text-[#6366F1] text-[13px] font-bold flex items-center justify-center flex-shrink-0">
        {initials}
      </div>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {isLead && (
            <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-[#EEF2FF] text-[#6366F1]">
              Lead
            </span>
          )}
        </div>
        ...
        <div className="flex gap-1.5 flex-wrap mt-1.5">
          ...
          <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-[#EEF2FF] text-[#6366F1]">
            {pct}%
          </span>
        </div>
      </div>
